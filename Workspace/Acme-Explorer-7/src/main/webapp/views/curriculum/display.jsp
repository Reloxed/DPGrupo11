...
<h3> <jstl:out value="${propietary} ${curriculum.ranger.userAccount.username}"> </jstl:out> </h3>

<%-- Botones para añadir Records al curriculum --%>
<jstl:if test="${curriculum.ranger.id == principal.id }">
	<table class="displayStyle">
		...
		<tr>
			<td>
				...
				onclick="redirect: location.href = 'professionalRecord/ranger/create.do';" />
			</td>
			
			<td>
				<input type="button" name="addER"
				value="<spring:message code="curriculum.addER" />"
				onclick="redirect: location.href = 'educationRecord/ranger/create.do';" />
			</td>
			<td>
				<input type="button" name="addENR"
				value="<spring:message code="curriculum.addENR" />"
				onclick="redirect: location.href = 'endorserRecord/ranger/create.do';" />
			</td>
			<td>
				<input type="button" name="addMR"
				value="<spring:message code="curriculum.addMR" />"
				onclick="redirect: location.href = 'miscellaneousRecord/ranger/create.do';" />
			</td>
		</tr>
...
<tr>
<th> <jstl:out value="${propietary} ${curriculum.ranger.userAccount.username}"> </jstl:out>  </th>
<th>   </th>
</tr>

<tr>
<td> <strong> <spring:message code="curriculum.propietary" /> : </strong> </td>
<td> <a href="actor/display.do?actorId=${curriculum.ranger.id}"><spring:message code="curriculum.display.ranger" /></a> </td>
</tr>
...
<td>
	...
	<td><a href="${curriculum.personalRecord.linkedInProfile }">${curriculum.personalRecord.linkedInProfile } </a></td>
	</tr>
	</table>
</td>
</tr>
...
<td>
	...
	<jstl:if test="${curriculum.ranger == principal}" >
	<tr>
		<td colspan="2">
			<br>
			<input type="button" name="edit"
			value="<spring:message code="curriculum.editPR" />"
			onclick="redirect: location.href = 'professionalRecord/ranger/edit.do?professionalRecordId=${PR.id}';" />
		</td>
	</tr>
	</jstl:if>
...
<td>
	...
	<tr>
		<td colspan="2">
			...
			onclick="redirect: location.href = 'educationRecord/ranger/edit.do?educationRecordId=${ER.id}';" />
		</td>
	</tr>
	</jstl:if>
...
<%-- Repetimos para endorserRecord --%>
<jstl:if test="${ not empty curriculum.endorserRecord}" >
<jstl:set var="countENR" value="1"/>
<tr>
<td> <strong> <spring:message code="curriculum.endorserRecords" /> : </strong> </td>
<td>
	<jstl:forEach var="ENR" items="${curriculum.endorserRecord}">
	<table class="displayStyle">
	<tr>
	<th><strong> <spring:message code="curriculum.endorserRecord" /> <jstl:out value="${countENR}"/></strong></th>
	<th></th>
	</tr>
	
	<tr>
	<td><strong> <spring:message code="curriculum.endorserRecord.name" />: </strong></td>
	<td><jstl:out value="${ENR.name}"/></td>
	</tr>
	
	<tr>
	<td><strong> <spring:message code="curriculum.endorserRecord.surname" />: </strong></td>
	<td><jstl:out value="${ENR.surname}"/></td>
	</tr>
	
	<tr>
	<td><strong> <spring:message code="curriculum.endorserRecord.email" />: </strong></td>
	<td><jstl:out value="${ENR.email}"/></td>
	</tr>
	
	<tr>
	<td><strong> <spring:message code="curriculum.endorserRecord.phone" />: </strong></td>
	<td><jstl:out value="${ENR.phone}"/></td>
	</tr>
	
	<tr>
	<td><strong> <spring:message code="curriculum.endorserRecord.linkedInProfile" />: </strong></td>
	<td><a href="${ENR.linkedInProfile }"><jstl:out value="${ENR.linkedInProfile}"/></a></td>
	</tr>
	
	<tr>
	<td><strong> <spring:message code="curriculum.endorserRecord.comments" />: </strong></td>
	<td>
		<ul>
		<jstl:forEach var="comment" items="${ENR.comments}">
			<li><jstl:out value="${comment }"/></li>
		</jstl:forEach>
		</ul>
	</td>
	</tr>
	<jstl:set var="countENR" value="${countENR+1}"/>
	...
	<tr>
		<td colspan="2">
			<br>
			<input type="button" name="edit"
			value="<spring:message code="curriculum.editENR" />"
			onclick="redirect: location.href = 'endorserRecord/ranger/edit.do?endorserRecordId=${ENR.id}';" />
		</td>
	</tr>
	</jstl:if>
...
<td>
	...
	<tr>
		<td colspan="2">
			...
			onclick="redirect: location.href = 'miscellaneousRecord/ranger/edit.do?miscellaneousRecordId=${MR.id}';" />
		</td>
	</tr>
	</jstl:if>
...
<jstl:if test="${curriculum.ranger == principal}" >
	<jstl:if test="${curriculum.id!=0}">
		...
		onclick="redirect: location.href = 'curriculum/ranger/edit.do?curriculumId=${curriculum.id}';" />
	</jstl:if>
</jstl:if>
</div>
