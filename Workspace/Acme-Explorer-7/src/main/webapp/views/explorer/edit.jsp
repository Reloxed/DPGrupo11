...
<form:form action="${actionURI}" modelAttribute="explorer" id="form" >
	...
	<spring:message code="explorer.phonePlaceholder" var="placeholder" />
	...
	<jstl:choose>
	<jstl:when test="${explorer.id == 0}">
	
	<form:hidden path="userAccount.authorities[0].authority" value="EXPLORER" />
	
	
	<form:label path="userAccount.username">
		<spring:message code="explorer.username" />:
	</form:label>
	<spring:message code="explorer.username.placeholder" var="usernamePlaceholder"/> 
	...
	<spring:message code="explorer.password.placeholder" var="passwordPlaceholder"/> 
...
$("#save").on("click",function(){validatePhone("<spring:message code='explorer.confirmationPhone'/>","${countryCode}");});
...
<jstl:if test="${!permission }">
<h3><spring:message code="explorer.nopermission" /></h3>
</jstl:if>
