...
<form:form action="sponsorship/sponsor/edit.do" modelAttribute="sponsorship">
	...
	<form:label path="linkBanner">
		<spring:message code="sponsorship.linkBanner" />:
	</form:label>
	<form:input path="linkBanner" />
	<form:errors cssClass="error" path="linkBanner" />
	<br />
<br/>
	...
	<form:input path="linkInfoPage" />
	<form:errors cssClass="error" path="linkInfoPage" />
	<br />
	<br/>
