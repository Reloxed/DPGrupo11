...
public class NoteService {
	...
	public Note save(final Note note) {
		...
		final String[] customerComments = note.getCustomerComment().split("(¿¡,.-_/!?) ");
		final String[] refereeComments = note.getRefereeComment().split("(¿¡,.-_/!?) ");
		final String[] handyComments = note.getHandyWorkerComment().split("(¿¡,.-_/!?) ");
