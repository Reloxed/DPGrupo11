...
<jstl:choose>
	<jstl:when test="${warranty.isFinal == true}">
		<h3>
			<spring:message code="warranty.nopermission" />
		</h3>
	</jstl:when>
	<jstl:otherwise>
		...
		<form:form action="warranty/administrator/edit.do"
			...
			<spring:message code="warranty.confirm.delete"
				var="confirmDeleteWarranty" />
	...
	<jstl:if test="${warranty.id != 0}">
			...
			<input type="button" name="cancel" value="${cancelWarranty}"
