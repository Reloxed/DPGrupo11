...
<jstl:choose>
	<jstl:when test="${report.id == 0 || report.isFinal == false}">
		...
		<form:form action="report/referee/edit.do" modelAttribute="report">
			...
			<fieldset>
				...
				<legend>
					<form:label path="attachments">
						<spring:message code="report.attachments" /> : </form:label>
				</legend>
				<div id="list">
					<jstl:choose>
					...
					<a href="#" class="list-add" onclick="event.preventDefault();">
						<spring:message code="report.attachment.add" />
					</a> &nbsp;&nbsp;
				</div>
			...
			<spring:message code="report.confirm.delete"
				var="confirmDeleteReport" />
			<spring:message code="report.cancel" var="cancelReport" />
			<spring:message code="report.save" var="saveReport" />
			...
			<jstl:if test="${report.id != 0}">
				...
				<input type="submit" name="delete" value="${deleteReport}"
	...
	<jstl:otherwise>
		<h3>
			<spring:message code="report.nopermission" />
		</h3>
	</jstl:otherwise>
</jstl:choose>